...
import MatchingApplyDetailPage from '@/views/MatchingApplyDetailPage.vue'; // 실제 경로에 맞게 수정해야 합니다.
...
import MatchingBoardPage from '@/views/MatchingBoardPage.vue'; // 실제 경로에 맞게 수정해야 합니다.
